...
import uno_data2
from uno_data2 import CombinedDataLoader, CombinedDataGenerator, DataFeeder
...
def set_up_logger(logfile, verbose):
    ...
    for log in [logger, uno_data2.logger]:
...
def run(params):
    ...
    if args.export_csv:
        ...
        if args.growth_bins > 1:
            df = uno_data2.discretize(df, 'Growth', bins=args.growth_bins)
    ...
    trained_model_json = 'uno.model.json'
    json_data_url = 'https://modac.cancer.gov/api/v2/dataObject/NCI_DOE_Archive/JDACS4C/JDACS4C_Pilot_1/unified_drug_response_predictor_uno/' \
                    + trained_model_json
    ...
    trained_model_h5 = 'uno.model.h5'
    h5_data_url = 'https://modac.cancer.gov/api/v2/dataObject/NCI_DOE_Archive/JDACS4C/JDACS4C_Pilot_1/unified_drug_response_predictor_uno/' \
                  + trained_model_h5
    ...
    loaded_model_json.compile(loss=args.loss, optimizer=optimizer, metrics=[mae, r2])
